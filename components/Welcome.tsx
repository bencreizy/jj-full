        ...
        <section className="py-20 md:py-32 border-y border-cyan-500/50 bg-black">
            <div className="container mx-auto px-4 text-center">
                ...
                <p className="max-w-4xl mx-auto text-lg md:text-xl text-gray-400 leading-relaxed">
                    ...
                    That's why we offer comprehensive on-site repairs, so if you have an 
                    emergency, we're available 24 hours a day. From advanced computer 
                    diagnostics to heavy-duty engine overhauls, our certified technicians 
                    have the tools and expertise to get you back on the road safely and 
                    swiftly. We're not just mechanics; we're your partners in performance.
                </p>
            </div>
        </section>
    );
